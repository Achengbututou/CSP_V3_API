...
namespace erpCase.bll
{
    ...
    /// 描 述： 物料类别配置数据库执行类
    /// </summary>
    public class CaseErpMaterialclassesService : ServiceBase
    {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        /// <returns></returns>
        private Expression<Func<CaseErpMaterialclassesEntity, bool>> GetExpression(CaseErpMaterialclassesEntity queryParams) {
            var exp = Expressionable.Create<CaseErpMaterialclassesEntity>();
        ...
        public Task<IEnumerable<CaseErpMaterialclassesEntity>> GetList(CaseErpMaterialclassesEntity queryParams)
        {
            ...
            return this.BaseRepository().FindList<CaseErpMaterialclassesEntity>(expression);
        }
        ...
        {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<CaseErpMaterialclassesEntity>(expression,pagination);
        }
        ...
        public Task<CaseErpMaterialclassesEntity> GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<CaseErpMaterialclassesEntity>(keyValue);
        }
        ...
        {
            await this.BaseRepository().Delete<CaseErpMaterialclassesEntity>(keyValue);
        }
        ...
        public async Task Deletes(string keyValues)
        {
            ...
            await this.BaseRepository().Delete<CaseErpMaterialclassesEntity>(keyValuesArr);
        }
