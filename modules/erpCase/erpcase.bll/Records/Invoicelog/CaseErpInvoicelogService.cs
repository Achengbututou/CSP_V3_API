...
namespace erpCase.bll
{
    ...
    /// 描 述： 开票记录数据库执行类
    /// </summary>
    public class CaseErpInvoicelogService : ServiceBase
    {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        /// <returns></returns>
        private Expression<Func<CaseErpInvoicelogEntity, bool>> GetExpression(CaseErpInvoicelogEntity queryParams) {
            var exp = Expressionable.Create<CaseErpInvoicelogEntity>();
            ...
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_InvoiceName),t => t.F_InvoiceName.Contains(queryParams.F_InvoiceName));
            ...
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_TicketName),t => t.F_TicketName.Contains(queryParams.F_TicketName));
        ...
        public Task<IEnumerable<CaseErpInvoicelogEntity>> GetList(CaseErpInvoicelogEntity queryParams)
        {
            ...
            return this.BaseRepository().FindList<CaseErpInvoicelogEntity>(expression);
        }
        ...
        {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<CaseErpInvoicelogEntity>(expression,pagination);
        }
        ...
        public Task<CaseErpInvoicelogEntity> GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<CaseErpInvoicelogEntity>(keyValue);
        }
        ...
        {
            await this.BaseRepository().Delete<CaseErpInvoicelogEntity>(keyValue);
        }
        ...
        public async Task Deletes(string keyValues)
        {
            ...
            await this.BaseRepository().Delete<CaseErpInvoicelogEntity>(keyValuesArr);
        }
