...
namespace erpCase.bll
{
    ...
    /// 描 述： 出库记录数据库执行类
    /// </summary>
    public class CaseErpOutstorelogService : ServiceBase
    {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        /// <returns></returns>
        private Expression<Func<CaseErpOutstorelogEntity, bool>> GetExpression(CaseErpOutstorelogEntity queryParams) {
            var exp = Expressionable.Create<CaseErpOutstorelogEntity>();
        ...
        public Task<IEnumerable<CaseErpOutstorelogEntity>> GetList(CaseErpOutstorelogEntity queryParams)
        {
            ...
            return this.BaseRepository().FindList<CaseErpOutstorelogEntity>(expression);
        }
        ...
        {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<CaseErpOutstorelogEntity>(expression,pagination,null,null, true);
        }
        ...
        public Task<CaseErpOutstorelogEntity> GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<CaseErpOutstorelogEntity>(keyValue);
        }
        ...
        {
            await this.BaseRepository().Delete<CaseErpOutstorelogEntity>(keyValue);
        }
        ...
        public async Task Deletes(string keyValues)
        {
            ...
            await this.BaseRepository().Delete<CaseErpOutstorelogEntity>(keyValuesArr);
        }
