...
namespace erpCase.bll
{
    ...
    /// 描 述： 仓库管理数据库执行类
    /// </summary>
    public class CaseErpWarehouselogService : ServiceBase
    {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        /// <returns></returns>
        private Expression<Func<CaseErpWarehouselogEntity, bool>> GetExpression(CaseErpWarehouselogEntity queryParams) {
            var exp = Expressionable.Create<CaseErpWarehouselogEntity>();
        ...
        public Task<IEnumerable<CaseErpWarehouselogEntity>> GetList(CaseErpWarehouselogEntity queryParams)
        {
            ...
            return this.BaseRepository().FindList<CaseErpWarehouselogEntity>(expression);
        }
        ...
        {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<CaseErpWarehouselogEntity>(expression,pagination);
        }
        ...
        public Task<CaseErpWarehouselogEntity> GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<CaseErpWarehouselogEntity>(keyValue);
        }
        ...
        {
            await this.BaseRepository().Delete<CaseErpWarehouselogEntity>(keyValue);
        }
        ...
        public async Task Deletes(string keyValues)
        {
            ...
            await this.BaseRepository().Delete<CaseErpWarehouselogEntity>(keyValuesArr);
        }
