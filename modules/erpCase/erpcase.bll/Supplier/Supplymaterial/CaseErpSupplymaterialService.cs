...
namespace erpCase.bll
{
    ...
    /// 描 述： 供应商供货清单数据库执行类
    /// </summary>
    public class CaseErpSupplymaterialService : ServiceBase
    {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        /// <returns></returns>
        private Expression<Func<CaseErpSupplymaterialEntity, bool>> GetExpression(CaseErpSupplymaterialEntity queryParams) {
            var exp = Expressionable.Create<CaseErpSupplymaterialEntity>();
        ...
        public Task<IEnumerable<CaseErpSupplymaterialEntity>> GetList(CaseErpSupplymaterialEntity queryParams)
        {
            ...
            return this.BaseRepository().FindList<CaseErpSupplymaterialEntity>(expression);
        }
        ...
        {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<CaseErpSupplymaterialEntity>(expression,pagination);
        }
        ...
        public Task<CaseErpSupplymaterialEntity> GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<CaseErpSupplymaterialEntity>(keyValue);
        }
        ...
        {
            await this.BaseRepository().Delete<CaseErpSupplymaterialEntity>(keyValue);
        }
        ...
        public async Task Deletes(string keyValues)
        {
            ...
            await this.BaseRepository().Delete<CaseErpSupplymaterialEntity>(keyValuesArr);
        }
