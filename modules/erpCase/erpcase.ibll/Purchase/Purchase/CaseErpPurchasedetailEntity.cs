...
namespace erpCase.ibll
{
    ...
    /// 描 述：case_erp_purchasedetail(采购订单详情【case_erp_purchasedetail】)表的实体
    /// </summary>
    [MyTable("case_erp_purchdetail")]
    public class CaseErpPurchasedetailEntity
    {
        #region 实体成员
        /// <summary>
        /// 唯一标识(GUID)
