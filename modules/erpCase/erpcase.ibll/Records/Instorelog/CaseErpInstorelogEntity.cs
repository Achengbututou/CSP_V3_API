...
namespace erpCase.ibll
{
    ...
    /// 描 述：case_erp_instorelog(入库记录【case_erp_instorelog】)表的实体
    /// </summary>
    [MyTable("case_erp_instorelog")]
    public class CaseErpInstorelogEntity
    {
        #region 实体成员
        /// <summary>
        /// 唯一标识(GUID)
        ...
        /// </summary>
        [Column(IsIgnore = true)]
        public decimal? SumInStore { get; set; }
