...
namespace erpCase.ibll
{
    ...
    /// 描 述：case_erp_invoicelog(开票记录【case_erp_invoicelog】)表的实体
    /// </summary>
    [MyTable("case_erp_invoicelog")]
    public class CaseErpInvoicelogEntity
    {
        #region 实体成员
        /// <summary>
        /// 唯一标识(GUID)
        ...
        /// 发票号码
        /// </summary>
        public string F_TicketNum { get; set; }
        /// <summary>
        /// 发票金额
        /// </summary>
        public decimal? F_TicketAmount { get; set; }
        /// <summary>
        /// 收票方
        /// </summary>
        public string F_TicketName { get; set; }
        /// <summary>
        /// 备注
        /// </summary>
