...
namespace mes.bll {
    ...
    /// 描 述： 检测类别数据库执行类
    /// </summary>
    public class MesDetectionCategoryService: ServiceBase {
        ...
        /// <returns></returns>
        private Expression<Func<MesDetectionCategoryEntity, bool>>GetExpression(MesDetectionCategoryEntity queryParams) {
            var exp = Expressionable.Create<MesDetectionCategoryEntity>();
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_DetectionCateCode), t => t.F_DetectionCateCode.Contains(queryParams.F_DetectionCateCode));
            if (queryParams.F_NumberState != null) {
                exp = exp.And(t => t.F_NumberState == queryParams.F_NumberState);
            }
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_DetectionCategory), t => t.F_DetectionCategory.Contains(queryParams.F_DetectionCategory));
        ...
        public Task<IEnumerable<MesDetectionCategoryEntity>>GetList(MesDetectionCategoryEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesDetectionCategoryEntity>(expression);
        }
        /// <summary>
        /// 获取检测类别的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesDetectionCategoryEntity>>GetPageList(Pagination pagination, MesDetectionCategoryEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesDetectionCategoryEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesDetectionCategoryEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesDetectionCategoryEntity>(keyValue);
        }
        #endregion
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesDetectionCategoryEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesDetectionCategoryEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
