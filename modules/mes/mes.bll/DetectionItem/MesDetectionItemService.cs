...
namespace mes.bll {
    ...
    /// 描 述： 检测项目数据库执行类
    /// </summary>
    public class MesDetectionItemService: ServiceBase {
        ...
        /// <returns></returns>
        private Expression<Func<MesDetectionItemEntity, bool>>GetExpression(MesDetectionItemEntity queryParams) {
            var exp = Expressionable.Create<MesDetectionItemEntity>();
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_DetectionItemCode), t => t.F_DetectionItemCode.Contains(queryParams.F_DetectionItemCode));
            if (queryParams.F_NumberState != null) {
                exp = exp.And(t => t.F_NumberState == queryParams.F_NumberState);
            }
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_DetectionItemName), t => t.F_DetectionItemName.Contains(queryParams.F_DetectionItemName));
        ...
        public Task<IEnumerable<MesDetectionItemEntity>>GetList(MesDetectionItemEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesDetectionItemEntity>(expression);
        }
        /// <summary>
        /// 获取检测项目的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesDetectionItemEntity>>GetPageList(Pagination pagination, MesDetectionItemEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesDetectionItemEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesDetectionItemEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesDetectionItemEntity>(keyValue);
        }
        #endregion
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesDetectionItemEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesDetectionItemEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
