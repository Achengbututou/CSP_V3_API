...
namespace mes.bll {
    ...
    /// 描 述： 检测方法数据库执行类
    /// </summary>
    public class MesDetectionMethodService: ServiceBase {
        ...
        /// <returns></returns>
        private Expression<Func<MesDetectionMethodEntity, bool>>GetExpression(MesDetectionMethodEntity queryParams) {
            var exp = Expressionable.Create<MesDetectionMethodEntity>();
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_MethodNumber), t => t.F_MethodNumber.Contains(queryParams.F_MethodNumber));
            if (queryParams.F_NumberState != null) {
                exp = exp.And(t => t.F_NumberState == queryParams.F_NumberState);
            }
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_MethodName), t => t.F_MethodName.Contains(queryParams.F_MethodName));
        ...
        public Task<IEnumerable<MesDetectionMethodEntity>>GetList(MesDetectionMethodEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesDetectionMethodEntity>(expression);
        }
        /// <summary>
        /// 获取检测方法的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesDetectionMethodEntity>>GetPageList(Pagination pagination, MesDetectionMethodEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesDetectionMethodEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesDetectionMethodEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesDetectionMethodEntity>(keyValue);
        }
        #endregion
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesDetectionMethodEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesDetectionMethodEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
