...
namespace mes.bll {
    ...
    /// 描 述： 设备类型数据库执行类
    /// </summary>
    public class MesDeviceTypeService: ServiceBase {
        ...
        /// <returns></returns>
        private Expression<Func<MesDeviceTypeEntity, bool>>GetExpression(MesDeviceTypeEntity queryParams) {
            var exp = Expressionable.Create<MesDeviceTypeEntity>();
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_DeviceTypeCode), t => t.F_DeviceTypeCode.Contains(queryParams.F_DeviceTypeCode));
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_DeviceTypeName), t => t.F_DeviceTypeName.Contains(queryParams.F_DeviceTypeName));
            if (queryParams.F_TypeSorting != null) {
                exp = exp.And(t => t.F_TypeSorting == queryParams.F_TypeSorting);
            }
        ...
        public Task<IEnumerable<MesDeviceTypeEntity>>GetList(MesDeviceTypeEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesDeviceTypeEntity>(expression);
        }
        /// <summary>
        /// 获取设备类型的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesDeviceTypeEntity>>GetPageList(Pagination pagination, MesDeviceTypeEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesDeviceTypeEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesDeviceTypeEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesDeviceTypeEntity>(keyValue);
        }
        #endregion
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesDeviceTypeEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesDeviceTypeEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
