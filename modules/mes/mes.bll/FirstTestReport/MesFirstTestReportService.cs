...
namespace mes.bll {
    ...
    /// 描 述： 收件确认数据库执行类
    /// </summary>
    public class MesFirstTestReportService: ServiceBase {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        ...
        /// <returns></returns>
        private Expression<Func<MesFirstTestReportEntity, bool>>GetExpression(MesFirstTestReportEntity queryParams) {
            var exp = Expressionable.Create<MesFirstTestReportEntity>();
        ...
        public Task<IEnumerable<MesFirstTestReportEntity>>GetList(MesFirstTestReportEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesFirstTestReportEntity>(expression);
        }
        /// <summary>
        /// 获取收件确认的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesFirstTestReportEntity>>GetPageList(Pagination pagination, MesFirstTestReportEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesFirstTestReportEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesFirstTestReportEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesFirstTestReportEntity>(keyValue);
        }
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesFirstTestReportEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesFirstTestReportEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
