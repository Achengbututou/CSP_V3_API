...
namespace mes.bll {
    ...
    /// 描 述： 库位信息数据库执行类
    /// </summary>
    public class MesLibraryLocationService: ServiceBase {
        ...
        /// <returns></returns>
        private Expression<Func<MesLibraryLocationEntity, bool>>GetExpression(MesLibraryLocationEntity queryParams) {
            var exp = Expressionable.Create<MesLibraryLocationEntity>();
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_LibraryLocationNumber), t => t.F_LibraryLocationNumber.Contains(queryParams.F_LibraryLocationNumber));
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_LibraryLocationName), t => t.F_LibraryLocationName.Contains(queryParams.F_LibraryLocationName));
        ...
        public Task<IEnumerable<MesLibraryLocationEntity>>GetList(MesLibraryLocationEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesLibraryLocationEntity>(expression);
        }
        /// <summary>
        /// 获取库位信息的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesLibraryLocationEntity>>GetPageList(Pagination pagination, MesLibraryLocationEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesLibraryLocationEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesLibraryLocationEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesLibraryLocationEntity>(keyValue);
        }
        #endregion
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesLibraryLocationEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesLibraryLocationEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
