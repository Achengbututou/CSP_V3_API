...
namespace mes.bll {
    ...
    /// 描 述： 工序类型数据库执行类
    /// </summary>
    public class MesProcessTypeService: ServiceBase {
        ...
        /// <returns></returns>
        private Expression<Func<MesProcessTypeEntity, bool>>GetExpression(MesProcessTypeEntity queryParams) {
            var exp = Expressionable.Create<MesProcessTypeEntity>();
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ProcessName), t => t.F_ProcessName.Contains(queryParams.F_ProcessName));
        ...
        public Task<IEnumerable<MesProcessTypeEntity>>GetList(MesProcessTypeEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesProcessTypeEntity>(expression);
        }
        /// <summary>
        /// 获取工序类型的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesProcessTypeEntity>>GetPageList(Pagination pagination, MesProcessTypeEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesProcessTypeEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesProcessTypeEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesProcessTypeEntity>(keyValue);
        }
        #endregion
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesProcessTypeEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesProcessTypeEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
