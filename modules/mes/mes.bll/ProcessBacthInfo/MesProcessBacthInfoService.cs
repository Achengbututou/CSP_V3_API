...
namespace mes.bll {
    ...
    /// 描 述： 工序派工批次数据库执行类
    /// </summary>
    public class MesProcessBacthInfoService: ServiceBase {
        ...
        /// <returns></returns>
        private Expression<Func<MesProcessBacthInfoEntity, bool>>GetExpression(MesProcessBacthInfoEntity queryParams) {
            var exp = Expressionable.Create<MesProcessBacthInfoEntity>();
            ...
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_BatchNumber), t => t.F_BatchNumber.Contains(queryParams.F_BatchNumber));
            ...
            if (queryParams.F_QuantityProduced != null) {
                exp = exp.And(t => t.F_QuantityProduced == queryParams.F_QuantityProduced);
            }
        ...
        public Task<IEnumerable<MesProcessBacthInfoEntity>>GetList(MesProcessBacthInfoEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesProcessBacthInfoEntity>(expression);
        }
        /// <summary>
        /// 获取工序派工批次的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesProcessBacthInfoEntity>>GetPageList(Pagination pagination, MesProcessBacthInfoEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesProcessBacthInfoEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesProcessBacthInfoEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesProcessBacthInfoEntity>(keyValue);
        }
        #endregion
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesProcessBacthInfoEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesProcessBacthInfoEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
