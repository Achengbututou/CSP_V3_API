...
namespace mes.bll
{
    ...
    /// 描 述： 工序管理数据库执行类
    /// </summary>
    public class MesProcessMaterialService : ServiceBase
    {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        ...
        /// <returns></returns>
        private Expression<Func<MesProcessMaterialEntity, bool>> GetExpression(MesProcessMaterialEntity queryParams)
        {
            var exp = Expressionable.Create<MesProcessMaterialEntity>();
        ...
        public Task<IEnumerable<MesProcessMaterialEntity>> GetList(MesProcessMaterialEntity queryParams)
        {
            ...
            return this.BaseRepository().FindList<MesProcessMaterialEntity>(expression);
        }
        /// <summary>
        /// 获取工序管理的分页数据
        /// </summary>
        ...
        {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesProcessMaterialEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        {
            return this.BaseRepository().FindEntityByKey<MesProcessMaterialEntity>(keyValue);
        }
        #endregion
        ...
        {
            await this.BaseRepository().Delete<MesProcessMaterialEntity>(keyValue);
        }
        /// <summary>
        /// 删除工序管理的数据根据外键
        /// </summary>
        ...
        {
            await this.BaseRepository().Delete<MesProcessMaterialEntity>(t => t.F_ProcessManagementId == key);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues)
        {
            ...
            await this.BaseRepository().Delete<MesProcessMaterialEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
        ...
        {
            var addList = new List<MesProcessMaterialEntity>();
            var db = this.BaseRepository().BeginTrans();
            try
            {
                await db.Delete<MesProcessMaterialEntity>(t => t.F_ProcessManagementId == key);
