...
namespace mes.bll
{
    ...
    /// 描 述： 工序管理数据库执行类
    /// </summary>
    public class MesProcessTechnologyService : ServiceBase
    {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        ...
        /// <returns></returns>
        private Expression<Func<MesProcessTechnologyEntity, bool>> GetExpression(MesProcessTechnologyEntity queryParams)
        {
            var exp = Expressionable.Create<MesProcessTechnologyEntity>();
            ...
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ParameterName), t => t.F_ParameterName.Contains(queryParams.F_ParameterName));
            if (queryParams.F_ParameterNum != null)
            {
                exp = exp.And(t => t.F_ParameterNum == queryParams.F_ParameterNum);
            }
        ...
        public Task<IEnumerable<MesProcessTechnologyEntity>> GetList(MesProcessTechnologyEntity queryParams)
        {
            ...
            return this.BaseRepository().FindList<MesProcessTechnologyEntity>(expression);
        }
        /// <summary>
        /// 获取工序管理的分页数据
        /// </summary>
        ...
        {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesProcessTechnologyEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        {
            return this.BaseRepository().FindEntityByKey<MesProcessTechnologyEntity>(keyValue);
        }
        #endregion
        ...
        {
            await this.BaseRepository().Delete<MesProcessTechnologyEntity>(keyValue);
        }
        /// <summary>
        /// 删除工序管理的数据根据外键
        /// </summary>
        ...
        {
            await this.BaseRepository().Delete<MesProcessTechnologyEntity>(t => t.F_ProcessManagementId == key);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues)
        {
            ...
            await this.BaseRepository().Delete<MesProcessTechnologyEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
        ...
        {
            var addList = new List<MesProcessTechnologyEntity>();
            var db = this.BaseRepository().BeginTrans();
            try
            {
                await db.Delete<MesProcessTechnologyEntity>(t => t.F_ProcessManagementId == key);
