...
namespace mes.bll {
    ...
    /// 描 述： 工艺路线管理数据库执行类
    /// </summary>
    public class MesProcessLineRouteService: ServiceBase {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        ...
        /// <returns></returns>
        private Expression<Func<MesProcessLineRouteEntity, bool>>GetExpression(MesProcessLineRouteEntity queryParams) {
            var exp = Expressionable.Create<MesProcessLineRouteEntity>();
            ...
            if (queryParams.Text != null) {
                exp = exp.And(t => t.Text == queryParams.Text);
            }
        ...
        public Task<IEnumerable<MesProcessLineRouteEntity>>GetList(MesProcessLineRouteEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesProcessLineRouteEntity>(expression);
        }
        /// <summary>
        /// 获取工艺路线管理的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesProcessLineRouteEntity>>GetPageList(Pagination pagination, MesProcessLineRouteEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesProcessLineRouteEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesProcessLineRouteEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesProcessLineRouteEntity>(keyValue);
        }
        #endregion
        #region 提交数据
        /// <summary>
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesProcessLineRouteEntity>(keyValue);
        }
        /// <summary>
        /// 删除工艺路线管理的数据根据外键
        /// </summary>
        ...
        public async Task DeleteRelate(string key) {
            await this.BaseRepository().Delete<MesProcessLineRouteEntity>(t => t.F_ProcessRouteId == key);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesProcessLineRouteEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
        ...
        public async Task SaveList(string key, IEnumerable<MesProcessLineRouteEntity>list) {
            var addList = new List<MesProcessLineRouteEntity>();
            var db = this.BaseRepository().BeginTrans();
            try {
                await db.Delete<MesProcessLineRouteEntity>(t => t.F_ProcessRouteId == key);
