...
namespace mes.bll {
    ...
    /// 描 述： 产线信息数据库执行类
    /// </summary>
    public class MesProductionLineService: ServiceBase {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        ...
        /// <returns></returns>
        private Expression<Func<MesProductionLineEntity, bool>>GetExpression(MesProductionLineEntity queryParams) {
            var exp = Expressionable.Create<MesProductionLineEntity>();
            ...
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ProductionName), t => t.F_ProductionName.Contains(queryParams.F_ProductionName));
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ProductionPrincipal), t => t.F_ProductionPrincipal.Contains(queryParams.F_ProductionPrincipal));
        ...
        public Task<IEnumerable<MesProductionLineEntity>>GetList(MesProductionLineEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesProductionLineEntity>(expression);
        }
        /// <summary>
        /// 获取产线信息的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesProductionLineEntity>>GetPageList(Pagination pagination, MesProductionLineEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesProductionLineEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesProductionLineEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesProductionLineEntity>(keyValue);
        }
        #endregion
        #region 提交数据
        /// <summary>
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesProductionLineEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesProductionLineEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
