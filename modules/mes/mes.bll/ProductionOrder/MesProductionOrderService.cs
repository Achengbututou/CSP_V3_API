...
namespace mes.bll {
    ...
    /// 描 述： 生产订单数据库执行类
    /// </summary>
    public class MesProductionOrderService: ServiceBase {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        ...
        /// <returns></returns>
        private Expression<Func<MesProductionOrderEntity, bool>>GetExpression(MesProductionOrderEntity queryParams) {
            var exp = Expressionable.Create<MesProductionOrderEntity>();
        ...
        public Task<IEnumerable<MesProductionOrderEntity>>GetList(MesProductionOrderEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesProductionOrderEntity>(expression);
        }
        /// <summary>
        /// 获取生产订单的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesProductionOrderEntity>>GetPageList(Pagination pagination, MesProductionOrderEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesProductionOrderEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesProductionOrderEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesProductionOrderEntity>(keyValue);
        }
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesProductionOrderEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesProductionOrderEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
