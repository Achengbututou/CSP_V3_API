...
namespace mes.bll {
    ...
    /// 描 述： 项目阶段数据库执行类
    /// </summary>
    public class MesProjectPhaseService: ServiceBase {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        ...
        /// <returns></returns>
        private Expression<Func<MesProjectPhaseEntity, bool>>GetExpression(MesProjectPhaseEntity queryParams) {
            var exp = Expressionable.Create<MesProjectPhaseEntity>();
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ProjectPhaseName), t => t.F_ProjectPhaseName.Contains(queryParams.F_ProjectPhaseName));
            if (queryParams.F_PhaseSorting != null) {
                exp = exp.And(t => t.F_PhaseSorting == queryParams.F_PhaseSorting);
            }
        ...
        /// <param name="queryParams">查询参数</param>
        /// <returns></returns>
        public Task<IEnumerable<MesProjectPhaseEntity>>GetList(MesProjectPhaseEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesProjectPhaseEntity>(expression);
        }
        /// <summary>
        /// 获取项目阶段的分页数据
        /// </summary>
        ...
        /// <param name="queryParams">查询参数</param>
        /// <returns></returns>
        public Task<IEnumerable<MesProjectPhaseEntity>>GetPageList(Pagination pagination, MesProjectPhaseEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesProjectPhaseEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        /// <returns></returns>
        public Task<MesProjectPhaseEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesProjectPhaseEntity>(keyValue);
        }
        #endregion
        #region 提交数据
        /// <summary>
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesProjectPhaseEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesProjectPhaseEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
        ...
        /// <returns></returns>
        public async Task SaveEntity(string keyValue, MesProjectPhaseEntity entity) {
