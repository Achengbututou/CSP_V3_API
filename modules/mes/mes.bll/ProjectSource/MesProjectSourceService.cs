...
namespace mes.bll {
    ...
    /// 描 述： 项目来源数据库执行类
    /// </summary>
    public class MesProjectSourceService: ServiceBase {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        ...
        /// <returns></returns>
        private Expression<Func<MesProjectSourceEntity, bool>>GetExpression(MesProjectSourceEntity queryParams) {
            var exp = Expressionable.Create<MesProjectSourceEntity>();
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ProjectSourceName), t => t.F_ProjectSourceName.Contains(queryParams.F_ProjectSourceName));
            if (queryParams.F_SourceSorting != null) {
                exp = exp.And(t => t.F_SourceSorting == queryParams.F_SourceSorting);
            }
        ...
        public Task<IEnumerable<MesProjectSourceEntity>>GetList(MesProjectSourceEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesProjectSourceEntity>(expression);
        }
        /// <summary>
        /// 获取项目来源的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesProjectSourceEntity>>GetPageList(Pagination pagination, MesProjectSourceEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesProjectSourceEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesProjectSourceEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesProjectSourceEntity>(keyValue);
        }
        #endregion
        #region 提交数据
        /// <summary>
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesProjectSourceEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesProjectSourceEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
