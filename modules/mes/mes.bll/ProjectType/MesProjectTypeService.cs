...
namespace mes.bll {
    ...
    /// 描 述： 项目类型数据库执行类
    /// </summary>
    public class MesProjectTypeService: ServiceBase {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        ...
        /// <returns></returns>
        private Expression<Func<MesProjectTypeEntity, bool>>GetExpression(MesProjectTypeEntity queryParams) {
            var exp = Expressionable.Create<MesProjectTypeEntity>();
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ProjectTypeName), t => t.F_ProjectTypeName.Contains(queryParams.F_ProjectTypeName));
        ...
        public Task<IEnumerable<MesProjectTypeEntity>>GetList(MesProjectTypeEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesProjectTypeEntity>(expression);
        }
        /// <summary>
        /// 获取项目类型的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesProjectTypeEntity>>GetPageList(Pagination pagination, MesProjectTypeEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesProjectTypeEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesProjectTypeEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesProjectTypeEntity>(keyValue);
        }
        #endregion
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesProjectTypeEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesProjectTypeEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
