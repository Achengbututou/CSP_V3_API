...
namespace mes.bll {
    ...
    /// 描 述： 库区信息数据库执行类
    /// </summary>
    public class MesReservoirAreaService: ServiceBase {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        ...
        /// <returns></returns>
        private Expression<Func<MesReservoirAreaEntity, bool>>GetExpression(MesReservoirAreaEntity queryParams) {
            var exp = Expressionable.Create<MesReservoirAreaEntity>();
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ReservoirAreaNumber), t => t.F_ReservoirAreaNumber.Contains(queryParams.F_ReservoirAreaNumber));
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ReservoirAreaName), t => t.F_ReservoirAreaName.Contains(queryParams.F_ReservoirAreaName));
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ClassificationId), t => t.F_ClassificationId.Contains(queryParams.F_ClassificationId));
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_WarehouseId), t => t.F_WarehouseId.Contains(queryParams.F_WarehouseId));
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ReservoirPrincipal), t => t.F_ReservoirPrincipal.Contains(queryParams.F_ReservoirPrincipal));
        ...
        public Task<IEnumerable<MesReservoirAreaEntity>>GetList(MesReservoirAreaEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesReservoirAreaEntity>(expression);
        }
        /// <summary>
        /// 获取库区信息的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesReservoirAreaEntity>>GetPageList(Pagination pagination, MesReservoirAreaEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesReservoirAreaEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesReservoirAreaEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesReservoirAreaEntity>(keyValue);
        }
        #endregion
        #region 提交数据
        /// <summary>
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesReservoirAreaEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesReservoirAreaEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
