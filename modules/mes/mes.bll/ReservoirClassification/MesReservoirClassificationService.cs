...
namespace mes.bll {
    ...
    /// 描 述： 库区分类数据库执行类
    /// </summary>
    public class MesReservoirClassificationService: ServiceBase {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        ...
        /// <returns></returns>
        private Expression<Func<MesReservoirClassificationEntity, bool>>GetExpression(MesReservoirClassificationEntity queryParams) {
            var exp = Expressionable.Create<MesReservoirClassificationEntity>();
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ClassificationNumber), t => t.F_ClassificationNumber.Contains(queryParams.F_ClassificationNumber));
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ClassificationName), t => t.F_ClassificationName.Contains(queryParams.F_ClassificationName));
        ...
        public Task<IEnumerable<MesReservoirClassificationEntity>>GetList(MesReservoirClassificationEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesReservoirClassificationEntity>(expression);
        }
        /// <summary>
        /// 获取库区分类的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesReservoirClassificationEntity>>GetPageList(Pagination pagination, MesReservoirClassificationEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesReservoirClassificationEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesReservoirClassificationEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesReservoirClassificationEntity>(keyValue);
        }
        #endregion
        #region 提交数据
        /// <summary>
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesReservoirClassificationEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesReservoirClassificationEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
