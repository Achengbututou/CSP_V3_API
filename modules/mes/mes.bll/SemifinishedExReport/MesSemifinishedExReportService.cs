...
namespace mes.bll {
    ...
    /// 描 述： 半成品检测报告数据库执行类
    /// </summary>
    public class MesSemifinishedExReportService: ServiceBase {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        ...
        /// <returns></returns>
        private Expression<Func<MesSemifinishedExReportEntity, bool>>GetExpression(MesSemifinishedExReportEntity queryParams) {
            var exp = Expressionable.Create<MesSemifinishedExReportEntity>();
            ...
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ExceptionDescription), t => t.F_ExceptionDescription.Contains(queryParams.F_ExceptionDescription));
        ...
        public Task<IEnumerable<MesSemifinishedExReportEntity>>GetList(MesSemifinishedExReportEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesSemifinishedExReportEntity>(expression);
        }
        /// <summary>
        /// 根据主键集合获取报告集合
        /// </summary>
        ...
        /// <returns></returns>
        public Task<IEnumerable<MesSemifinishedExReportEntity>> GetListBtIds(List<string> ids)
        {
            return this.BaseRepository().FindList<MesSemifinishedExReportEntity>(t => ids.Contains(t.F_Id));
        ...
        public Task<IEnumerable<MesSemifinishedExReportEntity>>GetPageList(Pagination pagination, MesSemifinishedExReportEntity queryParams) {
            return this.BaseRepository().FindListByQueryable<MesSemifinishedExReportEntity>(q => {
                var queryable = q.InnerJoin<MesSemifinishedReportEntity>((t, t1) => t.F_SemifinishedReportId == t1.F_Id);
                var expression = GetExpression(queryParams);
                queryable = queryable.Where(expression);
                return queryable.Select((t, t1) => new MesSemifinishedExReportEntity()
                {
                    F_Id = t.F_Id,
                    F_SemifinishedReportId = t.F_SemifinishedReportId,
                    F_ExceptionNumber = t.F_ExceptionNumber,
                    F_NumberState = t.F_NumberState,
                    F_ExceptionDescription = t.F_ExceptionDescription,
        ...
        public Task<MesSemifinishedExReportEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesSemifinishedExReportEntity>(keyValue);
        }
        #endregion
        #region 提交数据
        /// <summary>
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesSemifinishedExReportEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesSemifinishedExReportEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
