...
namespace mes.bll {
    ...
    /// 描 述： 储存类型数据库执行类
    /// </summary>
    public class MesStorageTypeService: ServiceBase {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        ...
        /// <returns></returns>
        private Expression<Func<MesStorageTypeEntity, bool>>GetExpression(MesStorageTypeEntity queryParams) {
            var exp = Expressionable.Create<MesStorageTypeEntity>();
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_StorageTypeNumber), t => t.F_StorageTypeNumber.Contains(queryParams.F_StorageTypeNumber));
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_StorageTypeName), t => t.F_StorageTypeName.Contains(queryParams.F_StorageTypeName));
        ...
        public Task<IEnumerable<MesStorageTypeEntity>>GetList(MesStorageTypeEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesStorageTypeEntity>(expression);
        }
        /// <summary>
        /// 获取储存类型的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesStorageTypeEntity>>GetPageList(Pagination pagination, MesStorageTypeEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesStorageTypeEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesStorageTypeEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesStorageTypeEntity>(keyValue);
        }
        #endregion
        #region 提交数据
        /// <summary>
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesStorageTypeEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesStorageTypeEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
