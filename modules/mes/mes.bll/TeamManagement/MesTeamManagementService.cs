...
namespace mes.bll {
    ...
    /// 描 述： 班组管理数据库执行类
    /// </summary>
    public class MesTeamManagementService: ServiceBase {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        ...
        /// <returns></returns>
        private Expression<Func<MesTeamManagementEntity, bool>>GetExpression(MesTeamManagementEntity queryParams) {
            var exp = Expressionable.Create<MesTeamManagementEntity>();
            ...
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_ProductionId), t => t.F_ProductionId.Contains(queryParams.F_ProductionId));
            if (queryParams.F_TeamState != null) {
                exp = exp.And(t => t.F_TeamState == queryParams.F_TeamState);
            }
            ...
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.Keyword), t => t.F_TeamManagementNumber.Contains(queryParams.Keyword) || t.F_TeamManagementName.Contains(queryParams.Keyword));
        ...
        public Task<IEnumerable<MesTeamManagementEntity>>GetList(MesTeamManagementEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesTeamManagementEntity>(expression);
        }
        /// <summary>
        /// 获取班组管理的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesTeamManagementEntity>>GetPageList(Pagination pagination, MesTeamManagementEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesTeamManagementEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesTeamManagementEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesTeamManagementEntity>(keyValue);
        }
        #endregion
        #region 提交数据
        /// <summary>
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesTeamManagementEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesTeamManagementEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
