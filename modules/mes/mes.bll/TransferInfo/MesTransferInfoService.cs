...
namespace mes.bll {
    ...
    /// 描 述： 调拨管理数据库执行类
    /// </summary>
    public class MesTransferInfoService: ServiceBase {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        ...
        /// <returns></returns>
        private Expression<Func<MesTransferInfoEntity, bool>>GetExpression(MesTransferInfoEntity queryParams) {
            var exp = Expressionable.Create<MesTransferInfoEntity>();
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_TransferNumber), t => t.F_TransferNumber.Contains(queryParams.F_TransferNumber));
        ...
        public Task<IEnumerable<MesTransferInfoEntity>>GetList(MesTransferInfoEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesTransferInfoEntity>(expression);
        }
        /// <summary>
        /// 获取调拨管理的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesTransferInfoEntity>>GetPageList(Pagination pagination, MesTransferInfoEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesTransferInfoEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        {
            var dataList = await this.BaseRepository().ORM.Queryable<MesTransferInfoEntity>()
                .LeftJoin<DepartmentEntity>((t, t1) => t.F_ApplicationDepartment == t1.F_DepartmentId)
                .LeftJoin<BaseUserEntity>((t, t1, t2) => t.F_Applicant == t2.F_UserId)
            .Where(t => t.F_Id == keyValue)
                .Select((t, t1, t2) => new MesTransferInfoEntity
                {
                    F_Id = t.F_Id,
                    F_TransferNumber = t.F_TransferNumber,
                    F_NumberState = t.F_NumberState,
                    F_TransferTheme = t.F_TransferTheme,
                    F_TransferDate = t.F_TransferDate,
                    F_ApplicationDepartment = t.F_ApplicationDepartment,
                    F_ApplicationDName = t1.F_FullName,
                    F_Applicant = t.F_Applicant,
                    F_ApplicantName = t2.F_RealName,
                    F_ContactNumber = t.F_ContactNumber,
                    F_TransferWarehouse = t.F_TransferWarehouse,
                    F_CallOutWarehouse = t.F_CallOutWarehouse,
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesTransferInfoEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesTransferInfoEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
