...
namespace mes.bll {
    ...
    /// 描 述： 仓库类型数据库执行类
    /// </summary>
    public class MesWarehouseTypeService: ServiceBase {
        #region 获取数据
        /// <summary>
        /// 获取查询表达式
        /// </summary>
        ...
        /// <returns></returns>
        private Expression<Func<MesWarehouseTypeEntity, bool>>GetExpression(MesWarehouseTypeEntity queryParams) {
            var exp = Expressionable.Create<MesWarehouseTypeEntity>();
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_WarehouseTypeNumber), t => t.F_WarehouseTypeNumber.Contains(queryParams.F_WarehouseTypeNumber));
            exp = exp.AndIF(!string.IsNullOrEmpty(queryParams.F_WarehouseTypeName), t => t.F_WarehouseTypeName.Contains(queryParams.F_WarehouseTypeName));
            if (queryParams.F_StorageTypeSort != null) {
                exp = exp.And(t => t.F_StorageTypeSort == queryParams.F_StorageTypeSort);
            }
            if (queryParams.F_StorageTypeState != null) {
                exp = exp.And(t => t.F_StorageTypeState == queryParams.F_StorageTypeState);
            }
        ...
        public Task<IEnumerable<MesWarehouseTypeEntity>>GetList(MesWarehouseTypeEntity queryParams) {
            ...
            return this.BaseRepository().FindList<MesWarehouseTypeEntity>(expression);
        }
        /// <summary>
        /// 获取仓库类型的分页数据
        /// </summary>
        ...
        public Task<IEnumerable<MesWarehouseTypeEntity>>GetPageList(Pagination pagination, MesWarehouseTypeEntity queryParams) {
            var expression = GetExpression(queryParams);
            return this.BaseRepository().FindList<MesWarehouseTypeEntity>(expression, pagination);
        }
        /// <summary>
        /// 获取实体数据
        /// </summary>
        ...
        public Task<MesWarehouseTypeEntity>GetEntity(string keyValue) {
            return this.BaseRepository().FindEntityByKey<MesWarehouseTypeEntity>(keyValue);
        }
        #endregion
        #region 提交数据
        /// <summary>
        ...
        public async Task Delete(string keyValue) {
            await this.BaseRepository().Delete<MesWarehouseTypeEntity>(keyValue);
        }
        /// <summary>
        /// 批量删除实体
        /// </summary>
        ...
        public async Task Deletes(string keyValues) {
            ...
            await this.BaseRepository().Delete<MesWarehouseTypeEntity>(keyValuesArr);
        }
        /// <summary>
        /// 保存数据
        /// </summary>
