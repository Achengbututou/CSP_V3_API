...
namespace mes.ibll
{
    ...
    /// 描 述：mes_detectcateg(检测类别信息维护)表的实体
    /// </summary>
    [MyTable("mes_detectcateg")]
    public class MesDetectionCategoryEntity
    {
        #region 实体成员
        /// <summary>
        /// 类别主键
        ...
        /// 检测类别编码
        /// </summary>
        public string F_DetectionCateCode { get; set; }
        /// <summary>
        /// 是否使用系统编码
        /// </summary>
        ...
        /// 检测类别
        /// </summary>
        public string F_DetectionCategory { get; set; }
        /// <summary>
        /// 状态
        /// </summary>
