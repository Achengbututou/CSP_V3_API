...
namespace mes.ibll
{
    ...
    /// 描 述：mes_detectitem(检测项目)表的实体
    /// </summary>
    [MyTable("mes_detectitem")]
    public class MesDetectionItemEntity
    {
        #region 实体成员
        /// <summary>
        /// 项目主键
        ...
        /// 检测项目编码
        /// </summary>
        public string F_DetectionItemCode { get; set; }
        /// <summary>
        /// 是否使用系统编码
        /// </summary>
        ...
        /// 检测项目
        /// </summary>
        public string F_DetectionItemName { get; set; }
        /// <summary>
        /// 状态
        /// </summary>
