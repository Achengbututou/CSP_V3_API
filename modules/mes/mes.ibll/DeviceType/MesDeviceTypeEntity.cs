...
namespace mes.ibll
{
    ...
    /// 描 述：mes_DeviceType(设备类型)表的实体
    /// </summary>
    [MyTable("mes_DeviceType")]
    public class MesDeviceTypeEntity
    {
        #region 实体成员
        /// <summary>
        /// 设备类型主键
        ...
        /// 设备类型编码
        /// </summary>
        public string F_DeviceTypeCode { get; set; }
        /// <summary>
        /// 设备名称
        /// </summary>
        ...
        /// 类型排序
        /// </summary>
        public int? F_TypeSorting { get; set; }
        /// <summary>
        /// 状态
        /// </summary>
