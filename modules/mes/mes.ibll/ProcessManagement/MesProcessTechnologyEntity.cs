...
namespace mes.ibll
{
    ...
    /// 描 述：mes_processtechnol(工序技术参数管理)表的实体
    /// </summary>
    [MyTable("mes_processtechnol")]
    public class MesProcessTechnologyEntity
    {
        #region 实体成员
        /// <summary>
        /// 工序管理主键
        ...
        /// 参数名称
        /// </summary>
        public string F_ParameterName { get; set; }
        /// <summary>
        /// 参数值
        /// </summary>
        public decimal? F_ParameterNum { get; set; }
        /// <summary>
        /// 备注
        /// </summary>
