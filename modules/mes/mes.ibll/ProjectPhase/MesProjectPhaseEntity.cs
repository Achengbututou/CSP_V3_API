...
namespace mes.ibll
{
    ...
    /// 描 述：mes_ProjectPhase(项目阶段)表的实体
    /// </summary>
    [MyTable("mes_ProjectPhase")]
    public class MesProjectPhaseEntity
    {
        #region 实体成员
        /// <summary>
        /// 项目阶段主键
        ...
        /// 项目阶段名称
        /// </summary>
        public string F_ProjectPhaseName { get; set; }
        /// <summary>
        /// 阶段排序
        /// </summary>
        public int? F_PhaseSorting { get; set; }
        /// <summary>
        /// 状态
        /// </summary>
