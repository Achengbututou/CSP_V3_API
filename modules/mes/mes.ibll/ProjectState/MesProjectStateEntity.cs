...
namespace mes.ibll
{
    ...
    /// 描 述：mes_ProjectState(项目状态)表的实体
    /// </summary>
    [MyTable("mes_ProjectState")]
    public class MesProjectStateEntity
    {
        #region 实体成员
        /// <summary>
        /// 项目状态主键
        ...
        /// 项目状态名称
        /// </summary>
        public string F_ProjectStateName { get; set; }
        /// <summary>
        /// 状态排序
        /// </summary>
        public int? F_StateSorting { get; set; }
        /// <summary>
        /// 状态
        /// </summary>
