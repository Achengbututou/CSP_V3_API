...
namespace mes.ibll
{
    ...
    /// 描 述：mes_scheduleorddeta(排期订单详情)表的实体
    /// </summary>
    [MyTable("mes_scheduleorddeta")]
    public class MesScheduleOrderDetailsEntity
    {
        #region 实体成员
        /// <summary>
        /// 排期订单主键
        ...
        /// 排期详情主键
        /// </summary>
        public string F_SchedulingDetailId { get; set; }
        /// <summary>
        /// 详情编码
        /// </summary>
        ...
        /// 订单数量
        /// </summary>
        public int? F_OrderNumber { get; set; }
        /// <summary>
        /// 排期数量
        /// </summary>
