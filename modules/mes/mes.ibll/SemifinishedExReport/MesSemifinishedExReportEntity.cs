...
namespace mes.ibll
{
    ...
    /// 描 述：mes_semifinishexrep(半成品校验异常报告)表的实体
    /// </summary>
    [MyTable("mes_semifinishexrep")]
    public class MesSemifinishedExReportEntity
    {
        #region 实体成员
        /// <summary>
        /// 异常报告主键
        ...
        /// 半成品报告主键
        /// </summary>
        public string F_SemifinishedReportId { get; set; }
        /// <summary>
        /// 异常报告编号
        /// </summary>
