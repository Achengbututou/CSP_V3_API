...
namespace mes.ibll
{
    ...
    /// 描 述：mes_semifinishdetail(半成品检验数据)表的实体
    /// </summary>
    [MyTable("mes_semifinishdetail")]
    public class MesSemifinishedDetailEntity
    {
        #region 实体成员
        /// <summary>
        /// 详细主键
        ...
        /// 半成品校验报告主键
        /// </summary>
        public string F_SemifinishedId { get; set; }
        /// <summary>
        /// 工单编号
        /// </summary>
        ...
        /// </summary>
        [Column(IsIgnore = true)]
        public string F_SemifinishedNumber { get; set; }
        /// <summary>
        /// 检验日期
        /// </summary>
        [Column(IsIgnore = true)]
        ...
        /// </summary>
        [Column(IsIgnore = true)]
        public string F_SamplesNumber { get; set; }
        /// <summary>
        /// 检验日期(时间查询范围)
        /// </summary>
        [Column(IsIgnore = true)]
