...
namespace mes.ibll
{
    ...
    /// 描 述：mes_teammanage(班组管理)表的实体
    /// </summary>
    [MyTable("mes_teammanage")]
    public class MesTeamManagementEntity
    {
        #region 实体成员
        /// <summary>
        /// 班组管理主键
        ...
        /// 所属产线
        /// </summary>
        public string F_ProductionId { get; set; }
        /// <summary>
        /// 状态
        /// </summary>
        public int? F_TeamState { get; set; }
        /// <summary>
        /// 备注
        /// </summary>
