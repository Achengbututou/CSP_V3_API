...
namespace mes.ibll
{
    ...
    /// 描 述：mes_WarehouseType(仓库类型管理)表的实体
    /// </summary>
    [MyTable("mes_WarehouseType")]
    public class MesWarehouseTypeEntity
    {
        #region 实体成员
        /// <summary>
        /// 仓库类型主键
        ...
        /// 仓库类型编号
        /// </summary>
        public string F_WarehouseTypeNumber { get; set; }
        /// <summary>
        /// 仓库类型名称
        /// </summary>
        public string F_WarehouseTypeName { get; set; }
        /// <summary>
        /// 仓库类型排序
        /// </summary>
